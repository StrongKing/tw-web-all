// const tl_01 = 'https://static.suosihulian.com/file/richText/img/tl_01.svg';
// const tl_02 = 'https://static.suosihulian.com/file/richText/img/tl_02.svg';
// const img1  = 'https://static.suosihulian.com/file/richText/img/img1.png';
// const img2  = 'https://static.suosihulian.com/file/richText/img/img2.png';
// const img3  = 'https://static.suosihulian.com/file/richText/img/img3.webp';
// const img4  = 'https://static.suosihulian.com/file/richText/img/img4.png';
// const img5  = 'https://static.suosihulian.com/file/richText/img/img5.webp';
// const img6  = 'https://static.suosihulian.com/file/richText/img/img6.png';
// const img7  = 'https://static.suosihulian.com/file/richText/img/phone.svg';
// const img7  = 'https://mqcai.top/cdn/phone.svg';

const importAll = (r) => {
  let images = [];
  r.keys().map((item, index) => {
    let img = `<img class="fn-emoji fn-emoji-${
...
export const MATLIB = (url) => {
  var tl_01 = `${url}/file/richText/img/tl_01.svg`;
  var tl_02 = `${url}/file/richText/img/tl_02.svg`;
  var img1 = `${url}/file/richText/img/img1.png`;
  var img2 = `${url}/file/richText/img/img2.png`;
  var img3 = `${url}/file/richText/img/img3.webp`;
  var img4 = `${url}/file/richText/img/img4.png`;
  var img5 = `${url}/file/richText/img/img5.webp`;
  var img6 = `${url}/file/richText/img/img6.png`;
  var img7 = `${url}/file/richText/img/phone.svg`;
  ...
  const _TL_BASE = [
    ...
    {
      key: 'tlbs007',
      data: `<div class='fn-tl_bs_7'><em>请输入标题</em></div>`,
    },
    { key: 'tlbs008', data: `<div class='fn-tl_bs_8'><em>描边文字</em></div>` },
    { key: 'tlbs009', data: `<div class='fn-tl_bs_9'><em>描边文字</em></div>` },
    {
      key: 'tlbs010',
      data: `<div class='fn-tl_bs_10'><em>输入标题</em></div>`,
    },
    {
      key: 'tlbs011',
      data: `<div class='fn-tl_bs_11'><em>简单阴影</em></div>`,
    },
  ];
  ...
  const _TL_LINE = [
    {
      key: 'tlli001',
      data: `<div class='fn-tl_li_1'><em>世界气象日</em></div>`,
    },
    {
      key: 'tlli002',
  ...
  const _IM_BASE = [
    {
      key: 'imbs001',
      data: `<div class='fn-im_bs_1'><img src=${img4} ></div>`,
    },
    {
      key: 'imbs010',
      data: `<div class='fn-im_bs_10'><img src=${img4} ></div>`,
    },
    {
      key: 'imbs011',
  ...
  const _IM_ONE = [
    ...
    {
      key: 'imon009',
      data: `<div class="fn-im_on_9"><img src=${img3} ></div>`,
    },
    {
      key: 'imon010',
    ...
    },
    {
      ...
      <div class="fn-co_qr_16">
        <div>
            ...
            <div class="m-hd">
              <section>Once we dreamt that we were strangers.We wake up to find that we were dear to each other.
              </section>
            </div>
            <div></div>
        </div>
  ...
  const _CO_SPLL = [
    {
      key: 'cosl001',
      data: `<div class='fn-co_sp_1'><a href="tel:96345100"><img src=${img7}><i>一键呼叫</i></a></div>`,
    },
    {
      key: 'cosl002',
  ...
  const _CO_QRCO = [
    ...
    {
      key: 'coqr015',
      data: `<div class="fn-co_qr_15"><div><div class="m-img"><img src="${img6}"></div><div class="m-bd"><em class="m-txt">创业资讯</em><em>微信号：xiumius</em><div><em>新浪微博：秀米XIUMI</em></div></div><div class="u-rd"></div></div></div>`,
    },
    {
      key: 'coqr016',
      data: `
  ...
  return [_TL, _CD, _IM, _LY, _CO, _EM];
};
