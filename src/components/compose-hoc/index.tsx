...
export interface ComposeTreeChildProps
  extends ComposeChildProps<{
    /** 当前激活的模块(模板) key */
...
export interface ComposeTabChildProps
  extends ComposeChildProps<{
    /** 当前激活的 tab key */
    activeKey: string;
    /** 当前组件是否激活 */
 ...
 * @param Com
 */
export default function composeHOC(
  Com: (props: ComposeChildProps<any>) => JSX.Element,
) {
