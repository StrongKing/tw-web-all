...
export interface PropTypes {
  ...
  dataRequest:
    | string
    | Request
    | { url?: string; method?: string; params?: any; isUnfold?: boolean };
  dataFormatter?: (data: any, params?: any) => any;
  searchDataFormatter?: (data: any) => any;
  /** 操作按钮 */
  ...
  /** 是否缓存列表筛选条件 */
  isCacheListFilter?: boolean;
  emptyText?: string;
  filterComsMap?: Record<string, any>;
  captionRight?: React.ReactNode;
  filterLabelWidth: number | 'auto';
  staticSearch?: (search: any) => void;
